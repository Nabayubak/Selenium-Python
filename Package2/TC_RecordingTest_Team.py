...
class RecordingTest_T(unittest.TestCase):
...
#Veriying mic allow and block icon
    ...
    def test4(self):
      ...
      # Publishing
      driver.find_element(By.XPATH, "//input[@placeholder = 'Enter URL (optional)']").send_keys("https://gogoanime.pe/")
      driver.find_element(By.XPATH, "//button[@variant='primary']").click()
      time.sleep(2)

      text = driver.find_element(By.XPATH, "//div[@class='ant-notification-notice-message']").text
      print(text)
      self.assertEqual("Publish Error", text, "Fail")

      driver.find_element(By.XPATH, "//input[@placeholder = 'Enter URL (optional)']").send_keys("https://ekajag.com/")
      driver.find_element(By.XPATH, "//button[@variant='primary']").click()
      time.sleep(2)
      Url = driver.current_url
    ...
    def test5(self):
      ...
      # Publishing
      driver.find_element(By.XPATH, "//input[@placeholder = 'Enter URL (optional)']").send_keys("hasdfsdfasdfasdfasdf")
      driver.find_element(By.XPATH, "//button[@variant='primary']").click()
      time.sleep(5)
